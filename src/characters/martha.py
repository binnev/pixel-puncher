...
from src.sprites.martha import martha_sprites


class Martha(Character):
    mass = 20
    width = 90
    height = 100
    color = Color("cyan")
    ...
    class Jab(Move):
        ...
        def __init__(self, character: Character):
            ...
            self.frame_mapping = [
                {"image": images[0]},
                {"image": images[1], "hitboxes": [h1]},
                {"image": images[2], "hitboxes": [h2]},
                {"image": images[3], "hitboxes": [h3]},
                {"image": images[4]},
                {"image": images[5]},
            ]
            super().__init__(character)
